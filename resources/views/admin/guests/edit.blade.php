<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.guests.index', $event) }}" class="text-sm text-gray-500 hover:text-gray-700">← Kembali</a>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-lg mx-auto px-4">
            <div class="bg-white rounded-2xl border border-gray-100 p-6">
                ...
                <form method="POST" action="{{ route('admin.guests.update', [$event, $guest]) }}">
                    @csrf
                    @method('PUT')

                    <div class="mb-4">
                        <label class="block text-sm text-gray-600 mb-1">Nama Utama</label>
                        <input type="text" name="nama_utama" value="{{ old('nama_utama', $guest->nama_utama) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nomor_undangan" value="{{ old('nomor_undangan', $guest->nomor_undangan) }}"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-300" />
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm text-gray-600 mb-1">Jumlah Tamu</label>
                        <input type="number" name="jumlah_tamu" value="{{ old('jumlah_tamu', $guest->jumlah_tamu) }}" min="1"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-300" />
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="jabatan" value="{{ old('jabatan', $guest->jabatan) }}"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-300" />
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="keterangan_undangan" value="{{ old('keterangan_undangan', $guest->keterangan_undangan) }}"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-300" />
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="kehadiran" value="{{ old('kehadiran', $guest->kehadiran) }}"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-300" />
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="keterangan" rows="3"
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-300">{{ old('keterangan', $guest->keterangan) }}</textarea>
